  ...
  render() {
    return (
      <div>
        ...
        <p>Please read these Terms of Use ("Terms", "Terms of Use") carefully before using the http://NotaFight.Club website (the "Service") operated by Not a Fight Club ("us", "we", or "our").</p>
